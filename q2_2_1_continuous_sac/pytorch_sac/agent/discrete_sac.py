...
class DiscreteSACAgent(Agent):
    def __init__(self, obs_dim, action_dim, action_range, device, critic_cfg,
        ...
        # The discrete critic returns Q-values for all actions at once.
        ...
        # Target entropy controls how random the policy should stay.
    ...
    def update(self, replay_buffer, logger, step):
        ...
        with torch.no_grad():
            ...
            target_V = (next_probs * (torch.min(target_Q1, target_Q2) - self.alpha * next_log_probs)).sum(-1, keepdim=True)
